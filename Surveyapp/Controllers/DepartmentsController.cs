...
namespace Surveyapp.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public DepartmentsController(SurveyContext context)
        {
            _context = context;
        }
        ...
        {
            var surveyContext = _context.Departments.Include(d => d.SchoolOrInstitution);
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var department = await _context.Departments
                .Include(d => d.SchoolOrInstitution)
        ...
        public async Task<IActionResult> Create([Bind("Id,Code,Name,SchoolOrInstitutionId")] Department department)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Code,Name,SchoolOrInstitutionId")] Department department)
        {
            if (id != department.Id)
            {
                return NotFound();
